...
| **Next Review** | Monthly (until all risks treated) |
...
| # | Action | Technical Details | Owner | Status | Due Date |
|---|--------|-------------------|-------|--------|----------|
...
**Residual Risk**: 6 🟡 MEDIUM (L=2, I=3)
...
**Residual Risk**: 8 🟡 MEDIUM (L=2, I=4)
...
**Residual Risk**: 8 🟡 MEDIUM (L=2, I=4) — with insurance transferring part of financial impact
...
| 5.2 | Configure SNS alerts (HIGH/CRITICAL findings → PagerDuty/Slack) | 08/06/2026 | ⏳ GAP-002 |
...
**Risk Score**: 12 🟠 HIGH — 🚨 **AWS FTR BLOCKER**  
**Treatment**: MITIGATE  
**Owner**: Cloud Infrastructure Lead  
...
| RTP | Risk | Score | Owner | Due Date | Key Actions |
|-----|------|-------|-------|----------|-------------|
...
## 5. Accepted Risks (No Treatment Plan)
...
| Asset | Control Status | Evidence | Last Verified |
|-------|----------------|----------|---------------|
...
| **CRITICAL risk not mitigated by due date** | Gestor SGSI → CEO (immediate) |
...
- ✅ All CRITICAL risks reduced to MEDIUM or lower
- ✅ All HIGH risks have treatment plan executed (may have residual risk)
